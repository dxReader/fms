<template>
    <div class="target-tree" style="width:100%;height:100%;">
        ...
        <!-- 主题一 -->
        <div class="target-tree" ref="trees">
            <ul class="tree-list">
...
.target-tree {
    .target-tree {
        ...
        @include themify($themes) {
            background-image: url('#{themed("bg-url")}/target/tree.png') ;
        }
            ...
            >div {
                .title {
                    ...
                    @include themify($themes) {
                        ...
                        background: rgba(themed('sub-main-color'), 0.5);
                ...
                .nodeActive{
                    ...
                    @include themify($themes) {
                        background: rgba(themed('sub-main-color'), 0.2);
                    }
