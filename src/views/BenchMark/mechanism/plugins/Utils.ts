...
export default class Utils {
    ...
    //节点下文本显示
    addShape(group: any, type: string, name: string, x: number, y: number, fontColor: string, fontSize: number = 18, fontWeight: number = 400, textAlign: string = 'center') {
    ...
    //节点中添加图片
    addShapeImg(group: any, width: number, height: number, x: number, y: number, img: string) {
