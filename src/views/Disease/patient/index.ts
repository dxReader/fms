...
export default class disPatient extends Vue {
    ...
    private tableHeader: any = [
        { value: 'naEmp', name: "主任(副主任)", width: "15%", align: 'left' },
        { value: 'rank', name: "出院人次", width: "15%", align: 'right' },
        { value: 'dept', name: "次均费用", width: "15%", align: 'left' },
        { value: 'value', name: "手术占比", width: "15%", align: 'right' },
        { value: 'value', name: "平均住院日", width: "20%", align: 'right' },
        { value: 'value', name: "患者平均年龄", width: "20%", align: 'right' },
    ];
    private listArr: any = [
        {
            icon: 'iconzhuyuan',
    ...
    private async docData() {
        ...
        this.isTableData(getData).then((res) => {
            if (res && res.data.length !== 0) {
                this.tableHeader = [
                    { value: 'naEmp', name: "主任(副主任)", width: "15%", align: 'left' },
                    { value: 'patientCount', name: "出院人次", width: "15%", align: 'right' },
                    { value: 'avgIncome', name: "次均费用", width: "18%", align: 'right' },
                    { value: 'operationPer', name: "手术占比", width: "16%", align: 'right' },
                    { value: 'avgInHospital', name: "平均住院日", width: "16%", align: 'right' },
                    { value: 'avgAge', name: "患者平均年龄", width: "20%", align: 'right' },
                ]
